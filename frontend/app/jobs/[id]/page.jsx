...
export default function JobDetailPage() {
  ...
  if (!job) return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4">
      <p className="text-xl font-semibold text-navy">Job not found</p>
    ...
    <div className="min-h-screen bg-bg-light">
      ...
      <div className="bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <button onClick={() => router.back()} className="flex items-center gap-2 text-sm text-gray-body hover:text-primary transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-border rounded-lg p-6">
              <div className="flex items-start gap-4 flex-wrap">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-body text-sm mt-1 flex flex-wrap items-center gap-3">
            ...
            {/* Description */}
            <div className="bg-white border border-border rounded-lg p-6">
              <h2 className="text-lg font-bold text-navy mb-4">Job Description</h2>
              <p className="text-gray-body text-sm leading-relaxed whitespace-pre-line">{job.description}</p>
            </div>

            {/* Requirements */}
            {job.requirements && (
              <div className="bg-white border border-border rounded-lg p-6">
                <h2 className="text-lg font-bold text-navy mb-4">Requirements</h2>
                <p className="text-gray-body text-sm leading-relaxed whitespace-pre-line">{job.requirements}</p>
              </div>
            )}
          </div>
            ...
            <div className="bg-white border border-border rounded-lg p-6 sticky top-24">
              {submitted ? (
                <div className="text-center py-6">
                  ...
                  <h3 className="font-bold text-navy text-lg">Application Sent!</h3>
                  <p className="text-gray-sub text-sm mt-2">Good luck! They'll be in touch if there's a match.</p>
                  <Link href="/jobs" className="btn-primary mt-6 block text-center text-sm">Browse More Jobs</Link>
                </div>
              ) : (
                <>
                  <h2 className="text-lg font-bold text-navy mb-1">Apply Now</h2>
                  <p className="text-gray-sub text-sm mb-5">Fill in the form below to apply.</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-navy mb-1">Resume Link *</label>
                      <input type="url" required placeholder="https://drive.google.com/..."
                        ...
                        className="input-field" />
                      <p className="text-xs text-gray-sub mt-1">Google Drive, Dropbox, or portfolio URL</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-navy mb-1">Cover Note</label>
